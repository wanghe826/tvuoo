...
@property (nonatomic, strong) EGOImageView* alertImageView;
   ...
   rightButtonTitle:(NSString *)rigthTitle
{
    if (self = [super init]) {
        ...
        self.alertTitleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0+65, kTitleYOffset, kAlertWidth, kTitleHeight)];
