...
#define CATE 3
#define PSP 4
@interface MyGameVc : UIViewController<UITableViewDataSource, UITableViewDelegate,CallBack>
{
...
@property (nonatomic, assign) int pspPageNum;
...
//三个列表的数据源
@property (nonatomic, retain) NSMutableArray* hotGameArray;//安卓游戏
@property (nonatomic, retain) NSMutableArray* niceGameArray;//街机游戏
@property (nonatomic, retain) NSMutableArray* cateGameArray;//红白机游戏
@property (nonatomic, retain) NSMutableArray* pspGameArray;//psp
